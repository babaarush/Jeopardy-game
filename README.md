...
<head>
    ...
    <style>
        ...
        @keyframes fadeIn {
            from { opacity: 0.1; } /*TO-DO: change the opacity back to 0*/
            to { opacity: 1; }
        }
        #question {
            font-size: 1.5em;
    ...
    <script>
        const questions = {
            Functions: {
                ...
                200: {
                    question: "This organelle is produces energy through photosynthesis.",
                    answer: "chloroplasts"
                },
                300: {
            ...
            Definitions: {
                ...
                200: {
                    question: "This oragnelle makes proteins/lipids for the cell.",
                    answer: "endoplasmic reticulum"
                },
                300: {
                ...
                500: {
                    question: "This organelle destorys old cells/waste .",
                    answer: "lysosome"
                }
            }
        };
